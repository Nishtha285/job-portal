                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" placeholder="Job Title" id="title" value="{{ $job->title }}" name="title" class="form-control">
                                    <p></p>
                                </div>
                                <div class="col-md-6  mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" min="1" placeholder="Vacancy" id="vacancy" value="{{ $job->vacancy }}" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" placeholder="location" id="location" value="{{ $job->location }}" name="location" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" placeholder="Website" id="website" value="{{ $job->company_website }}" name="company_website" class="form-control">
                            </div>
                        </div> 
