...
<head>
	...
	<title>CareerVibe | @yield('title', 'CareerVibe | Find Best Jobs')</title>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="profilePicForm" name="profilePicForm" method="post" enctype="multipart/form-data">
            <div class="mb-3">
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6">© 2026 Amrita infovison pvt. ltd. company, all right reserved</p>
</div>
</footer> 
